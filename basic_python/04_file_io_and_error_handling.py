"""
Koan 4: File I/O and Error Handling - The Mystery Begins (MEDIUM)
==================================================================

🔍 THE MYSTERY BEGINS...

You're a network engineer at TechCorp. This morning, several network devices went
offline mysteriously. Your manager hands you a USB drive with log files and says:
"Something's not right. These devices were fine yesterday. Find out what happened."

You plug in the drive and find several text files. Time to investigate!
